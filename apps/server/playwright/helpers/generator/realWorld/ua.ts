...
export function generateRandomUserAgent(deviceType?: string, browserType?: string) {
  ...
  if (deviceType === 'android') {
    ...
    const _iosDevice = getRandomElement(iosDevices)
    if (browserType === 'chrome') {
    ...
    const _ubuntuVersion = getRandomElement(ubuntuVersions)
    if (browserType === 'chrome') {
