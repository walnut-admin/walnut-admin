...
**最后核实**：2026-09-23 ｜ 15 个 workspace 包 ｜ 全门禁绿（`prepush` 十段 / `lint` / `types:check` / `test` / `boundaries` / `syncpack` / `build` / `build:docs` / `lint:adr`）
...
| **未裁决** | 2026-09-21 评审提出，**尚未决定做不做** | F7–F9 · D1–D6 · D8<br><sub>F0–F6 **全部完成**；D7（TS 7 排期）已并入 R7</sub> |

**已清掉的旧账**（2026-09-23 起逐条做掉即从本表移除，验收口径见文末「核实记录」与「执行记录」）：
R1 改判回退 → 已按决定搁置 ｜ R2 按决定不修（写明现状）｜ R3 · R4 · P3-18 · P3-19 · **R11** · **F1** ·
**R8** · **F6** · **F2-a** · **F2③** · **P2-10** · **P3-14** · **P3-15** · **P3-17** 已做完
