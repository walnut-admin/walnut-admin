...
// NOTE: ^ anchor added — the original pattern only anchored on $, so strings with
// junk prefixes (e.g. "abc+8613800138000") were accepted. Full-anchor matches
// isEmailAddress and is what callers (form validation) expect.
const phoneRegex
